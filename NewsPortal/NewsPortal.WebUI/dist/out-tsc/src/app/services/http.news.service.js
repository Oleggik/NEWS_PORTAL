        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.http.post(HttpQueryStrings_1.HttpQueryStrings.ApiNews, news, this.options).toPromise()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.http.delete(HttpQueryStrings_1.HttpQueryStrings.ApiNews + news, this.options).toPromise()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        ex_2 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.http.put(HttpQueryStrings_1.HttpQueryStrings.ApiNews, news, this.options).toPromise()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        ex_3 = _a.sent();
    ...
    HttpNewsService.prototype.getNewsById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetNewsById + id;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    HttpNewsService.prototype.getNews = function (skip, top) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.ODataNewsPublished + '&$skip=' + skip + '&$top=' + top;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
    ...
    HttpNewsService.prototype.getNewsByCategory = function (id, skip, top) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetNewsByCategory + id + '&$skip=' + skip + '&$top=' + top;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
    ...
    HttpNewsService.prototype.getAllNewsElastic = function (from, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetAllNewsFromElastic + 'from=' + from + '&count=' + size;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
    ...
    HttpNewsService.prototype.getNewsCategoryElastic = function (value, from, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetNewsFromCategoryElastic + 'category=' + value + '&from=' + from + '&count=' + size;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
    ...
    HttpNewsService.prototype.getNewsValueElastic = function (value, from, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetNewsFromValueElastic + 'searchTerm=' + value + '&from=' + from + '&count=' + size;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
    ...
    HttpNewsService.prototype.getNewsValueAndCategoryElastic = function (value, category, from, size) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = HttpQueryStrings_1.HttpQueryStrings.GetNewsFromValueElastic + 'category=' + category + '&searchTerm=' + value + '&from=' + from + '&count=' + size;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.http.get(query, this.options).toPromise()];
...
exports.HttpNewsService = HttpNewsService;
//# sourceMappingURL=http.news.service.js.map