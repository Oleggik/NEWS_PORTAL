...
var CreateCategoryComponent = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status == 200) {
                            ...
                            data = response.json();
                            tempError = ParserErrorResponse_1.ParsingErrorResponse.parsingCreatedCategoryResponse(data);
    ...
    CreateCategoryComponent = __decorate([
        core_1.Component({
            ...
            providers: [http_category_service_1.HttpCategoryService]
        }),
...
//# sourceMappingURL=createcategory.component.js.map