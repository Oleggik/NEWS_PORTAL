...
var ModelsError_1 = require("../../models/ModelsError");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, httpAuthService) {
        ...
        this.user = new LoginModel_1.LoginUser();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.status == 200) {
                            ...
                            data = response.json();
                            this.error = ParserErrorResponse_1.ParsingErrorResponse.parsingLoginUser(data);
                        }
                        else if (response.status == 404) {
                            err = new ModelsError_1.ModelErrors();
                            err.Field = "Auth";
    ...
    LoginComponent = __decorate([
        core_1.Component({
            ...
            providers: [http_auth_service_1.HttpAuthService]
        }),
