...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			$.each(this.settings.Categories, function(key, value) {
		...
		check: function( element ) {
			...
			// if radio/checkbox, validate first element in Category instead
		...
		idOrName: function(element) {
			return this.Categories[element.name] || (this.checkable(element) ? element.name : element.id || element.name);
		},
